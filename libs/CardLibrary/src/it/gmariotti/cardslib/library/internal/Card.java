...
/**
 * Main Card Model </p> You can customize this component. See
 * https://github.com/gabrielemariotti/cardslib/tree/master/doc/CARD.md for more
 * information. </p> You can easily extend and customize this class providing
 * your inner layout and setting your values with
...
public class Card extends BaseCard {
	...
	/**
	 * Used to enable a swipe gesture and its listener
	 * {@link Card#setOnClickListener(OnCardClickListener)}
	 */
	...
	/**
	 * Global area It is used by partial click listener
	 */
	public static final int CLICK_LISTENER_ALL_VIEW = 0;

	/**
	 * Thumbnail area It is used by partial click listener
	 */
	public static final int CLICK_LISTENER_THUMBNAIL_VIEW = 1;

	/**
	 * Header Area It is used by partial click listener
	 */
	public static final int CLICK_LISTENER_HEADER_VIEW = 2;

	/**
	 * Content Main area. It is used by partial click listener
	 */
	 ...
	 * can use a xml layout with {@link Card#setInnerLayout(int)} or with
	 * constructor {@link Card#Card(android.content.Context, int)}
	 * <p/>
	...
	public void setupInnerViewElements(ViewGroup parent, View view) {
		...
		if (view != null) {
			TextView mTitleView = (TextView) view
	...
	/**
	 * Adds a {@link CardThumbnail} Set the parent card in CardThumbnail.
	 * 
	 * @param cardThumbnail
	 */
	...
	/**
	 * Adds a {@link CardHeader}. Set set ParentCard inside Header.
	 * 
	 * @param cardHeader
	 */
	...
	/**
	 * Sets listener invoked when card is swiped. If listener is
	 * <code>null</code> the card is not swipeable.
	 * 
	 ...
	 * 
	 * @param onUndoSwipeListListener
	 *            listener
	 */
	public void setOnUndoSwipeListListener(
	...
	/**
	 * Sets listener invoked when card is clicked If listener is
	 * <code>null</code> then card is not clickable.
	 * 
	...
	/**
	 * Sets listener invoked when card is long clicked If listener is
	 * <code>null</code> then card is not long clickable.
	 * 
	 * @param onLongClickListener
	 */
	public void setOnLongClickListener(
			OnLongCardClickListener onLongClickListener) {
	 ...
	 * 
	 * @param onExpandAnimatorEndListener
	 *            listener
	 */
	public void setOnExpandAnimatorEndListener(
			OnExpandAnimatorEndListener onExpandAnimatorEndListener) {
	 ...
	 */
	public void setOnCollapseAnimatorEndListener(
			OnCollapseAnimatorEndListener onCollapseAnimatorEndListener) {
	...
	/**
	 * Returns <code>true</code> if the card is clickable If card hasn't a
	 * {@link OnCardClickListener} or any partial Listener return
	 * <code>true</code> in any cases.
	 * 
	 * @return
	 */
	public boolean isClickable() {
		if (mIsClickable) {
			if (mOnClickListener == null
					&& (mMultipleOnClickListener == null || mMultipleOnClickListener
							.isEmpty())) {
	...
	/**
	 * Indicates if the card is long clickable If card hasn't a
	 * {@link OnLongCardClickListener} return <code>false</code> in any cases.
	 * 
	 * @return
	 */
	public boolean isLongClickable() {
		if (mOnLongClickListener == null) {
			if (mIsLongClickable)
				Log.w(TAG,
						"LongClickable set to true without onLongClickListener");
			return false;
		}
	...
	/**
	 * Adds a clickListener on a specific area </p> You can use one of these
	 * values: {@link Card#CLICK_LISTENER_ALL_VIEW}
	 ...
	 * @param onClickListener
	 */
	public void addPartialOnClickListener(int area,
			OnCardClickListener onClickListener) {

		if (area < CLICK_LISTENER_ALL_VIEW
				&& area > CLICK_LISTENER_CONTENT_VIEW)
	...
	/**
	 * Remove ClickListener from a specif area </p> You can use one of these
	 * values: {@link Card#CLICK_LISTENER_ALL_VIEW}
	 * {@link Card#CLICK_LISTENER_HEADER_VIEW}
	 * {@link Card#CLICK_LISTENER_THUMBNAIL_VIEW}
	 * {@link Card#CLICK_LISTENER_CONTENT_VIEW}
	 ...
	 * 
	 * @return <code>true</code> if card is ExpandLayout is visible, otherwise
	 ...
	 * 
	 * @param expanded
	 *            <code>true</code> to indicates that the card is expanded
	 */
	...
	/**
	 * Checks if 2 cards have the same innerLayouts It can be used to force
	 * inner layout redraw
	 * 
	 * @param oldCard
	 * @param newCard
	...
	public static boolean equalsInnerLayout(Card oldCard, Card newCard) {
		...
		if (oldCard.getCardHeader() != null) {
			if (newCard.getCardHeader() == null)
				return true;
			else if (oldCard.getCardHeader().getInnerLayout() != newCard
					.getCardHeader().getInnerLayout())
				return true;
		} else {
			if (newCard.getCardHeader() != null)
				return true;
		...
		if (oldCard.getCardThumbnail() != null) {
			if (newCard.getCardThumbnail() == null)
				return true;
			else if (oldCard.getCardThumbnail().getInnerLayout() != newCard
					.getCardThumbnail().getInnerLayout())
				return true;
		} else {
			if (newCard.getCardThumbnail() != null)
				return true;
		...
		if (oldCard.getCardExpand() != null) {
			if (newCard.getCardExpand() == null)
				return true;
			else if (oldCard.getCardExpand().getInnerLayout() != newCard
					.getCardExpand().getInnerLayout())
				return true;
		} else {
			if (newCard.getCardExpand() != null)
				return true;
	...
	/**
	 * Sets the background drawable resource to override the style of MainLayout
	 * (card.main_layout)
	 * 
	 ...
	 * 
	 * @param checkable
	 *            <code>true</code> to indicates that the card is clickable
	 */
